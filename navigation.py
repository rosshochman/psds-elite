...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get('logged_in', False):
            ...
            #st.page_link("pages/page6.py", label="Keyword Tracker", icon="🔒")
            #st.page_link("pages/page7.py", label="Ticker Lookup", icon="🔒")
            #st.page_link("pages/page8.py", label="SEC Litigation & News Full Text Search", icon="🔒")
